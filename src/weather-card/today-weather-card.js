...
const RenderTodayCard = (props) => {
    ...
    const getForecast = useCallback(async () => {
          ...
          setMaxTemp(request.data.forecast.forecastday[0].day.maxtemp_c);
          setMinTemp(request.data.forecast.forecastday[0].day.mintemp_c);
          setWindCondition(request.data.forecast.forecastday[0].day.maxwind_kph);
          setCondition(request.data.forecast.forecastday[0].day.condition.text);
          setRainChance(request.data.forecast.forecastday[0].day.daily_chance_of_rain);
          setCity(request.data.location.name)
          setDate(request.data.forecast.forecastday[0].date)
          setActive(true)
  ...
  export default RenderTodayCard
